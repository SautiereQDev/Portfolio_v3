...
export const Service = () => {
  return (
    <main className="relative flex size-full min-h-screen flex-col bg-white group/design-root overflow-x-hidden font-[Manrope]">
        ...
        <section className="px-40 flex flex-1 justify-center py-5">
          <article className="layout-content-container flex flex-col max-w-[960px] flex-1">
            <figure className="@container">
              ...
              <figcaption className="sr-only">Service banner</figcaption>
            </figure>
            ...
            <section>
              ...
              <article className="flex items-center gap-4 bg-white px-4 min-h-[72px] py-2">
                <div
            ...
            <footer className="flex px-4 py-3 justify-end">
              <Link
                to="/contact"
